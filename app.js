const menu = [
  ...
  },
  {
    ...
    category: "lunch",
    price: 13.99,
    img: "https://lh3.googleusercontent.com/proxy/I-bEfHIAbi37erlrjgsZ_zfqfCBKeo0NgMLWZ6GPLSiZiZ5Nhp1JeAdgXSf7GdrzbCXOByhSyeRhKavRopCL3P0BuUikn64qkGk1hs5Y45ecSyYalC0QVxn_mLJmqUdy7IUYJx7QjU_XE_Re89rB8jFhmtgpNMOWWehfPyJWWe9Ncg",
...
function displayMenuButtons() {
  ...
  const caregoryBtn = categories
    .map(function (category) {
      return `<button class="filter-btn" type="button" data-id=${category}>${category}</button>`;
    })
    .join("");
  container.innerHTML = caregoryBtn;
